...
from nautobot.core.api.utils import get_serializer_for_model, nest_flat_dict, validate_field_paths
...
class ExportObjectList(Job):
    ...
    htmx_template_name = "extras/htmx/export_job_form_modal.html"
...
class ImportObjects(Job):
    ...
    htmx_template_name = "extras/htmx/import_job_form_modal.html"
