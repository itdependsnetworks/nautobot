    ...
    def to_internal_value(self, data):
        ...
        if isinstance(data, dict):
            ...
            try:
                ...
                raise ValidationError(missing_related_object_message(queryset.model, params))
            except MultipleObjectsReturned:
                raise ValidationError(
                    ambiguous_related_object_message(queryset.model, params, queryset.filter(**params).count())
                )
