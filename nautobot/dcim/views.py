...
class BreakoutTemplateUIViewSet(NautobotUIViewSet):
    ...
    def mapping_editor(self, request):
        ...
        # Auto-generate if no valid mapping provided or counts changed
        ...
        # Note: Potentially can make a component for this.
        return render(
            request,
...
class CableUIViewSet(NautobotUIViewSet):
    ...
    def _render_lane_form(self, request, cable):
        ...
        template_id = request.GET.get("breakout_template")
        if template_id:
            try:
                from nautobot.dcim.models import BreakoutTemplate

                cable.breakout_template = BreakoutTemplate.objects.get(pk=template_id)
            except BreakoutTemplate.DoesNotExist:
                pass
    ...
    def get_extra_context(self, request, instance):
        ...
        if isinstance(instance, PathEndpoint):
            ...
            if path and instance.cable_id:
                ...
                if cable and cable.breakout_template_id:
