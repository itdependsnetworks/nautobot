...
class CableTermination(models.Model):
    ...
    def get_cable_peers(self):
        ...
        my_endpoint = CableTerminationEndpoint.objects.filter(
            cable_id=self.cable_id, termination_id=self.pk
        ).first()
        if not my_endpoint:
            return []
        ...
        if self.cable.breakout_template_id and my_endpoint.connector is not None:
            ...
            for entry in self.cable.breakout_template.mapping:
