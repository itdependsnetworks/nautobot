...
class Migration(migrations.Migration):
    dependencies = [
        ...
        ("dcim", "0085_populate_default_breakout_templates"),
    ]
    operations = [
        ...
        migrations.AddField(
            model_name="cable", name="breakout_template",
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT,
                                    related_name="cables", to="dcim.breakouttemplate"),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("_termination_device", models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name="+", to="dcim.device")),
                ("cable", models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name="terminations", to="dcim.cable")),
                ("termination_type", models.ForeignKey(
                    limit_choices_to=models.Q(models.Q(
                        models.Q(("app_label", "circuits"), ("model__in", ("circuittermination",))),
                        models.Q(("app_label", "dcim"), ("model__in", ("consoleport", "consoleserverport", "frontport", "interface", "powerfeed", "poweroutlet", "powerport", "rearport"))),
                        _connector="OR",
                    )),
                    on_delete=django.db.models.deletion.PROTECT, related_name="+", to="contenttypes.contenttype",
                )),
            ],
            options={"ordering": ["cable", "cable_end", "connector", "position"], "unique_together": {("termination_type", "termination_id")}},
        ),
    ]
