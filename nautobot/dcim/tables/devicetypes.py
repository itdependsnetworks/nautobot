...
class ComponentTemplateTable(BaseTable):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # The `name` column links via `get_absolute_url()`, which resolves the template's parent
        # device type (and module type, for modular component templates) per row; the accessor
        # walk can't see into `get_absolute_url()`.
